...
#: 返すため、空の場合の文言は呼び出し側（prompt_builder.build_recent_log_feedback）が持つ
...
def send_reading_feedback(
    ...
    *,
    ...
    context = prompt_builder.RecentLogFeedbackContext(
        ...
        recent_logs=ai_context_service.build_recent_recalls_entries(
            session, active_books, target_date, recent_days
        ),
        recent_logs_key="recent_recalls",
        recent_logs_empty_text=_NO_RECENT_RECALLS_TEXT,
